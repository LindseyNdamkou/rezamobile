...
export class InscriptionPage implements OnInit {
  ...
  ngOnInit() {
    ...
    this.formulaireInscription = new FormGroup({
      ...
      sexe: new FormControl(null,[Validators.required, Validators.maxLength(50)]),
  ...
  onSubmit(){
    ...
    if(this.formulaireInscription.value.email == null || this.formulaireInscription.value.password == null ||
      ...
      this.formulaireInscription.value.phone == null || this.formulaireInscription.value.sexe== null||
